...
# with command line options: --python_filename AtoGammaGamma_MoverE_pythia8_AOD.py --eventcontent AODSIM --customise Configuration/DataProcessing/Utils.addMonitoring --datatier AODSIM --fileout file:AtoGammaGamma_MoverE_pythia8_AOD.root --conditions 106X_upgrade2018_realistic_v11_L1v1 -s RAW2DIGI,L1Reco,RECO,RECOSIM --geometry DB:Extended --filein file:AtoGammaGamma_MoverE_pythia8_HLT.root --era Run2_2018 --mc -n 10 --customise_commands process.source.bypassVersionCheck=cms.untracked.bool(True) --no_exec
...
outputfile = sys.argv[3] if sys.argv[3] != '' else 'AOD.root'
