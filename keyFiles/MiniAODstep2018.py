...
# with command line options: step 3 --filein file:AOD2018.root --fileout file:MiniAOD2018.root --python_filename MiniAODstep2018.py --eventcontent MINIAODSIM --datatier MINIAODSIM --conditions auto:phase1_2018_realistic --step PAT --nThreads 8 --geometry DB:Extended --era Run2_2018 --no_exec -n 10 --mc
