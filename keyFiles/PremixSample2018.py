...
# with command line options: step1 --evt_type Configuration/Generator/python/SingleNuE10_cfi.py -s GEN,SIM,DIGI:pdigi_valid -n 10 --conditions auto:phase1_2018_realistic --datatier PREMIX --eventcontent PREMIX --procModifiers premix_stage1 --era Run2_2018 --relval 100000,100 --pileup AVE_35_BX_25ns --pileup_input file:MinBiasSample2018.root --no_exec --python_filename PremixSample2018.py --fileout file:PremixSample2018.root
...
outputfile = sys.argv[4] if sys.argv[4] != '' else 'Premix.root'

process = cms.Process('DIGI',Run2_2018,premix_stage1)
...
process.mix.input.fileNames = cms.untracked.vstring(['file:'+inputfile])
